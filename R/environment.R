...
#' @title Environments
#'
#' @description Aquatic environments for aquaculture, defined by FAO (2022).
#'
#' @usage
#' environment
#'
...
#' environment
#'
#' # Aquaculture production by environment in 2020, in million tonnes
#' x <- merge(aquaculture, environment)
#' x <- aggregate(value~environment_name, x, sum, subset=year==2020)
